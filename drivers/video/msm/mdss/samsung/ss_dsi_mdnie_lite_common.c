					...
					for (j = 0; j < MAX_MODE; j++) {
						if ((mdnie_data.mdnie_tune_value_dsi0[i][j][0] != NULL) && (i != eBOOK_APP) && (j != READING_MODE)) {
							if(mdnie_data.dsi0_adjust_ldu_table[j] != NULL) {
								...
								ldu_tunning_data[mdnie_data.dsi0_rgb_sensor_mdnie_index].payload[mdnie_data.address_scr_white[ADDRESS_SCR_WHITE_RED_OFFSET]] = mdnie_data.dsi0_adjust_ldu_table[j][idx * 3 + 0];
								ldu_tunning_data[mdnie_data.dsi0_rgb_sensor_mdnie_index].payload[mdnie_data.address_scr_white[ADDRESS_SCR_WHITE_GREEN_OFFSET]] = mdnie_data.dsi0_adjust_ldu_table[j][idx * 3 + 1];
								ldu_tunning_data[mdnie_data.dsi0_rgb_sensor_mdnie_index].payload[mdnie_data.address_scr_white[ADDRESS_SCR_WHITE_BLUE_OFFSET]] = mdnie_data.dsi0_adjust_ldu_table[j][idx * 3 + 2];
							}
						}
					}
				}
					...
					for (j = 0; j < MAX_MODE; j++) {
						if ((mdnie_data.mdnie_tune_value_dsi1[i][j][0] != NULL) && (i != eBOOK_APP) && (j != READING_MODE)) {
							if(mdnie_data.dsi1_adjust_ldu_table[j] != NULL) {
								...
								ldu_tunning_data[mdnie_data.dsi1_rgb_sensor_mdnie_index].payload[mdnie_data.address_scr_white[ADDRESS_SCR_WHITE_RED_OFFSET]] = mdnie_data.dsi1_adjust_ldu_table[j][idx * 3 + 0];
								ldu_tunning_data[mdnie_data.dsi1_rgb_sensor_mdnie_index].payload[mdnie_data.address_scr_white[ADDRESS_SCR_WHITE_GREEN_OFFSET]] = mdnie_data.dsi1_adjust_ldu_table[j][idx * 3 + 1];
								ldu_tunning_data[mdnie_data.dsi1_rgb_sensor_mdnie_index].payload[mdnie_data.address_scr_white[ADDRESS_SCR_WHITE_BLUE_OFFSET]] = mdnie_data.dsi1_adjust_ldu_table[j][idx * 3 + 2];
							}
						}
					}
				}
